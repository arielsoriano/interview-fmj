...
**Chosen:**
- `get_it` (9.2.0) - Service locator implementation
- `injectable` (2.5.0) - Code generation for dependency registration
...
**Chosen:** `shared_preferences` (2.3.3)
...
**Chosen:** `very_good_analysis` (10.1.0)
