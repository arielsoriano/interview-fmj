...
**Chosen:**
- `get_it` (8.3.0) - Service locator implementation
- `injectable` (2.7.1+4) - Code generation for dependency registration
...
**Chosen:** `shared_preferences` (2.5.4)
...
**Chosen:** `very_good_analysis` (6.0.0)
